...
pclippy() {
    cargo clippy --all-targets --all-features $1 -- \
        ...
        -D clippy::rest_pat_in_fully_bound_structs -D clippy::undocumented_unsafe_blocks -D clippy::unnecessary_safety_comment -D clippy::unneeded_field_pattern -D clippy::unwrap_used \
        -D clippy::verbose_file_reads -D clippy::negative_feature_names -D clippy::redundant_feature_names -D clippy::wildcard_dependencies -D clippy::iter_with_drain -D clippy::missing_const_for_fn \
        -D clippy::mutex_atomic -D clippy::mutex_integer -D clippy::nonstandard_macro_braces -D clippy::path_buf_push_overwrite -D clippy::redundant_pub_crate -D clippy::suspicious_operation_groupings \
